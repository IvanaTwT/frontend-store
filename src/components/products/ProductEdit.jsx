...
export default function ProductEdit({ product, onClose }) {
    ...
    const product_completo = products.find(
        (p) => p.id_producto === product.id_producto
    );
    // si product no tiene todos los campos, usar el producto completo del contexto
    const inicial = product_completo ?? product;
    const [
        {
            data: dataUpdate,
    ...
    const [formData, setFormData] = useState({
        ...
        id_producto: inicial.id_producto,
        id_categoria: inicial.id_categoria,
        categoria_edad: inicial.categoria_edad,
        nombre: inicial.nombre,
        talle: inicial.talle,
        color: inicial.color,
        path_image: inicial.path_image || "",
